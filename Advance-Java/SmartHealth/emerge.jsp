<%-- 
    Document   : emerge
    Created on : 27 Feb, 2022, 7:25:14 PM
...
<html>
    ...
    <body>
        <div class="menu">
            ...
            <div class="getinfo">
                <p>Write down the name of disease you are infected with.</p>
                <br>
                <form action="show.jsp" method="post">
                    <input type="text" placeholder="Disease name here..."name="disease"> <input type="submit" value="Submit" id="button"></form> 
                     <span style="color:#ff0033">${message}</span>
            </div>
            <div class="footer">
