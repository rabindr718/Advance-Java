<%-- 
    Document   : loggin
    Created on : 24 Feb, 2022, 1:36:51 AM
...
<head>
    ...
    <style>
        * {
        ...
        .log {
            background-image: url('https://wallpaperaccess.com/full/624114.jpg');
            z-index: -1;
            opacity: 0.3;
            line-height: 16rem;
            position: relative;
    ...
    <div class="menu">
        <div class="nav">
            <button id="btn"><i class="fa fa-search" aria-hidden="true"></i> <input type="text" name="search"
                    id="search" placeholder="Search your text"> </button>
        ...
        <div class="navbar">
            <a href="index.html"><i class="fa fa-home" aria-hidden="true" style="font-size: xx-large;"></i></a>
            <a href="HealthTopics.jsp">Health Topics</a>
            <a href="emerge.jsp">Emergencies</a>
            <a href="signUP.html">Sign Up/Log In</a>
            <a href="aboutUS.jsp">About Us</a>
        </div>
        <div class="log"><br><br></div>
        <div class="login" style="width: 40%; text-align: center;">
            <h2>Member Login</h2><br>
            <!-- <div class="user"> -->
            <form action="loginServlet" method="post">
                <p style="color:#ff0033">${message}</p><br>
            ...
            <p style="text-align: center; color: grey;">OR</p> <br>
            <button type="submit" style="width: 10rem;">Connect With <i class="fa fa-google"
                    aria-hidden="true"></i></button> <br> <br>
                    <div class="foot">New User?<a href="signUP.html"> Create new account</a></div>
        </div>
    </div>
          <div class="footer">
